...
export const topRatingItems: PosterItem[] = [
  ...
  },
  {
    ...
    description: "Sekelompok siswa terjebak di sekolah saat wabah zombie menyebar, memaksa mereka bertahan hidup tanpa bantuan orang dewasa.",
    ...
    episodes: [
      {
        ...
        number: 1,
        title: "Episode 1",
        description: "Sebuah insiden di laboratorium sekolah memicu kepanikan yang cepat menyebar ke seluruh gedung.",
        duration: "65 min",
        imageUrl: allOfUsPreview,
      },
      {
        id: "allofus-e2",
        number: 2,
        title: "Episode 2",
        description: "Para siswa mencari tempat aman ketika lorong dan kelas berubah menjadi zona berbahaya.",
        duration: "70 min",
        imageUrl: allOfUsPreview,
      },
      {
        ...
        number: 3,
        title: "Episode 3",
        description: "Rencana penyelamatan makin sulit saat komunikasi keluar sekolah mulai terputus.",
        duration: "62 min",
        imageUrl: allOfUsPreview,
      },
    ],
